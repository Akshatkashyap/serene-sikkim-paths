...
export const monasteries: Monastery[] = [
  {
    ...
    description:
      "The Dharma Chakra Centre, also known as Rumtek Monastery, is one of the most significant monasteries in Sikkim and the largest in the state.",
  ...
  },
  {
    ...
    description:
      "One of the oldest and premier monasteries of Sikkim, built for 'ta-tshang' monks - the pure monks of the Nyingma order.",
  ...
  },
  {
    ...
    description:
      "Perched on a conical hill between the Rathong and Rangeet rivers, considered one of the most sacred places in Sikkim.",
  ...
  },
  {
    ...
    description:
      "Built on a site blessed by Lama Druptob Karpo, known for its tantric rituals and sacred dances.",
  ...
  },
  {
    ...
    description:
      "A hidden gem rebuilt after the original was destroyed, known for its beautiful murals and peaceful atmosphere.",
  ...
  },
  {
    ...
    description:
      "A serene monastery offering spectacular views of the Kanchenjunga range, perfect for meditation and contemplation.",
